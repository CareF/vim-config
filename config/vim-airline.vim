...
let g:airline_powerline_fonts=1 " Enable powerline fonts, powerline-fonts is required. 
" (`pacman -S powerline-fonts`, see https://powerline.readthedocs.io/en/master/installation.html#patched-fonts 
